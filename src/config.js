module.exports = {
  ...
  siteHeadline: 'Creating marvelous & blazing fast websites', // Headline for schema.org JSONLD
  ...
  siteDescription:
    'Minimalistic portfolio for a web developer, using GatsbyJS.',
